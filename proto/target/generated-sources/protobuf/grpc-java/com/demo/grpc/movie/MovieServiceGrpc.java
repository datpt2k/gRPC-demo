...
public final class MovieServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.movie.MovieSearchRequest,
      com.demo.grpc.movie.MovieSearchResponse> getGetMoviesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getMovies",
      requestType = com.demo.grpc.movie.MovieSearchRequest.class,
      responseType = com.demo.grpc.movie.MovieSearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.movie.MovieSearchRequest,
      com.demo.grpc.movie.MovieSearchResponse> getGetMoviesMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.movie.MovieSearchRequest, com.demo.grpc.movie.MovieSearchResponse> getGetMoviesMethod;
      ...
      synchronized (MovieServiceGrpc.class) {
        if ((getGetMoviesMethod = MovieServiceGrpc.getGetMoviesMethod) == null) {
          MovieServiceGrpc.getGetMoviesMethod = getGetMoviesMethod = 
              io.grpc.MethodDescriptor.<com.demo.grpc.movie.MovieSearchRequest, com.demo.grpc.movie.MovieSearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MovieService", "getMovies"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.movie.MovieSearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.movie.MovieSearchResponse.getDefaultInstance()))
  ...
  public static abstract class MovieServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMovies(com.demo.grpc.movie.MovieSearchRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.movie.MovieSearchResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.demo.grpc.movie.MovieSearchRequest,
                com.demo.grpc.movie.MovieSearchResponse>(
  ...
  public static final class MovieServiceBlockingStub extends io.grpc.stub.AbstractStub<MovieServiceBlockingStub> {
    ...
    /**
     */
    public com.demo.grpc.movie.MovieSearchResponse getMovies(com.demo.grpc.movie.MovieSearchRequest request) {
  ...
  public static final class MovieServiceFutureStub extends io.grpc.stub.AbstractStub<MovieServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.movie.MovieSearchResponse> getMovies(
        com.demo.grpc.movie.MovieSearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MOVIES:
          serviceImpl.getMovies((com.demo.grpc.movie.MovieSearchRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.movie.MovieSearchResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MovieServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.grpc.movie.MovieServiceOuterClass.getDescriptor();
    }
